...
def forwardsig(x, w1, w2, predict=False):
    a1 = np.matmul(x, w1)
...
def backpropsig(a1, z0, z1, z2, y, w2):
    delta2 = z2 - y
...
def forwardtan(x, w1, w2, predict=False):
    a1 = np.matmul(x, w1)
...
def backproptan(a1, z0, z1, z2, y, w2):
    delta2 = z2 - y
    Delta2 = np.matmul(z1.T, delta2)
    deltal = (delta2.dot(w2[1:, :].T)) * Tanh_dirv(a1)
    Deltal = np.matmul(z0.T, deltal)
    return delta2, Deltal, Delta2

def forwardrelu(x, w1, w2, predict=False):
    a1 = np.matmul(x, w1)
...
def backproprelu(a1, z0, z1, z2, y, w2):
    delta2 = z2 - y
    Delta2 = np.matmul(z1.T, delta2)
    deltal = (delta2.dot(w2[1:, :].T)) * Relu_dirv(a1)
    Deltal = np.matmul(z0.T, deltal)
    return delta2, Deltal, Delta2
...
def XORTan(inp):
    ...
    for i in range(epochs):
        ...
        a1, z1, a2, z2 = forwardtan(X, w1, w2)

        delta2, Deltal, Delta2 = backproptan(a1, X, z1, z2, y, w2)
...
def XORRelu(inp):
    ...
    for i in range(epochs):
        ...
        a1, z1, a2, z2 = forwardrelu(X, w1, w2)

        delta2, Deltal, Delta2 = backproprelu(a1, X, z1, z2, y, w2)
...
def XNORsig(inp):
    ...
    for i in range(epochs):
        ...
        a1, z1, a2, z2 = forwardsig(X, w1, w2)

        delta2, Deltal, Delta2 = backpropsig(a1, X, z1, z2, y, w2)
